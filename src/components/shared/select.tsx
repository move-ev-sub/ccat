...
const selectTriggerVariants = cva([
  ...
  // base
  'h-9 max-w-52 w-full justify-between',
  // invalid
  ...
  // disabled
  'disabled:bg-primary-100 disabled:opacity-100 disabled:text-primary-500',
]);
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-background text-foreground border-border-input relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border shadow-md',
          position === 'popper' &&
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        'text-secondary px-2 py-1.5 text-xs font-medium',
        className
      )}
      {...props}
    />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          "[&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-md py-1.5 pr-8 pl-2 text-sm font-medium outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
          'focus:bg-background-muted focus:text-accent-foreground',
        ],
        className
      )}
      {...props}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        'bg-border-input pointer-events-none -mx-1 my-1 h-px',
        className
      )}
      {...props}
    />
