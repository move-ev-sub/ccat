...
export const inputVariants = cva([
  'rounded-lg border-border-input border text-sm font-medium text-foreground placeholder:text-secondary h-9 flex justify-start items-center px-3.5 py-2 transition-colors',
  'shadow-sm',
