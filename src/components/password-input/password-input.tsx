    ...
    <div className={className}>
      <div className="flex items-center justify-start gap-2.5">
        <input
          ...
          className={cn(
            'border-border placeholder:text-secondary bg-background flex h-9 w-full grow rounded-lg border px-3 py-1 text-base transition-colors disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
            'focus-indicator'
          )}
