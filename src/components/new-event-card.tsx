...
export function NewEventCard({
  ...
  return (
    <Link
      className={cn(
        'bg-background-muted border-border-secondary text-muted-foreground group focus-indicator flex min-h-48 items-center justify-center gap-1.5 rounded-xl border border-dashed p-8 text-sm font-medium transition-colors',
        className
      )}
      href={href}
      {...props}
